...
export default function GlitchVaultProfile() {
  return <main className="w-full  flex flex-col items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0"></div>
      <GlitchVault className="w-full max-w-sm backdrop-blur-xl bg-white/20 dark:bg-black/20 border border-white/30 dark:border-white/10 rounded-2xl shadow-2xl shadow-cyan-500/10 relative z-10" glitchColor="#0AF0F0" glitchRadius={120}>
